...
for f in core/tc_sha1.c core/tc_base64.c core/tc_ws.c core/tc_draw.c core/tc_ui.c \
         core/tc_png.c core/tc_send.c core/tc_app.c core/tc_tls.c core/tc_json.c core/tc_imgdec.c core/tc_recv.c core/tc_keyboard.c core/tc_lobby.c platform/wii/plat_wii.c platform/wii/main.c; do
